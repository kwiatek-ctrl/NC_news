...
const seed = ({ topicData, userData, articleData, commentData }) => {
  ...
  .then(() => {
    ...
    const articlesTable = format(`INSERT INTO articles(title, topic, author, body, created_at, votes, article_img_url) VALUES %L RETURNING *;`, formatedArticleData);
  ...
  .then((result) => {
    ...
    const commentTable = format(`INSERT INTO comments(article_id, body, votes, author, created_at) VALUES %L;`, formatedCommentData);
